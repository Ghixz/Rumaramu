...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar">
      ...
      <div class="logo">
        <a class="navbar-brand" href="/tentang">Rumaramu</a>
      </div>
        ...
        <div class="right box">
          <div class="content">
            <ul>
              ...
              <li><a class="item-d" href="#"><i class="fa fa-facebook-square"></i>Rumaramu Malang</a></li>
              <li><a class="item-d" href="#"><i class="fa fa-instagram"></i>rumaramu_mlg</a></li>
              <li><a class="item-d" href="#"><i class="fa fa-whatsapp"></i>08123215912</a></li>
            </ul>
          </div>
        </div>
      </div>
